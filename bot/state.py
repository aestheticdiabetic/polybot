...
class StateManager:
    ...
    def update_markets(self, snapshot: list):
        self._markets_snapshot = snapshot
    ...
    def get_dashboard_data(self) -> dict:
        ...
        return {
            ...
            "metrics": {
                ...
                "total_fees_usdc": round(self._trader_stats.get("total_fees_usdc", 0.0), 4),
                "total_gas_usdc": round(self._trader_stats.get("total_gas_usdc", 0.0), 4),
